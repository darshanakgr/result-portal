...
db.ref().child('rank').once('value').then(function (data) {
    var arr = data.val();
    ...
    for(var index in arr){
        ...
        rowData.insertCell(0).innerHTML = arr[index].rank;
        rowData.insertCell(1).innerHTML = index;
        rowData.insertCell(2).innerHTML = arr[index].name;
